                            ...
                            <div className="row gx-5">
                                ...
                                <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                                    ...
                                    <div className="link-animated d-flex flex-column justify-content-start">
                                        ...
                                        <Link className="text-light mb-2" href="#"><i className="bi bi-arrow-right text-primary me-2"></i>Meet The Team</Link>
                    ...
                    <div className="row justify-content-end">
                        <div className="col-lg-8 col-md-6">
                            <div className="d-flex align-items-center justify-content-center" style={{ height: '75px' }}>
                                <p className="mb-0">&copy; <Link className="text-white border-bottom" href="#">Your Site Name</Link>. All Rights Reserved.
                                    Designed by <Link className="text-white border-bottom" href="https://htmlcodex.com">HTML Codex</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
