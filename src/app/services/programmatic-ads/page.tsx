...
const ProgrammaticsAds = () => {
    return (
        <div>
                ...
                <div className="container py-5">
                    <div className="row">
                        ...
                        <div className="col-md-6 col-6">
                            ...
                            <div className="text-start mt-4">
                                <h2 className="h2 text-primary mb-1 mt-5 text-start">Using...</h2>
                                <ul>
                                    <li> Audio</li>
                                    <li> Connected TV & </li>
                    ...
                    <div className="row g-5">
                        <div className="col-lg-4">
                            <div className="row g-5">
                                <div className="col-12 wow zoomIn" data-wow-delay="0.2s">
                                    ...
                                    <p className="mb-0">
                                        Reach & find potential buyers across the
                                        internet on mobile apps, websites, connected
                                        TV, online radio, YouTube. Hyper target at
                                        scale
                                    </p>
                                </div>
                                <div className="col-12 wow zoomIn" data-wow-delay="0.6s">
                                    <h4 className="text-primary">Put your historical data to use</h4>
                                    <p className="mb-0">
                                        Extract meaningful audience insights:
                                        Association with 3rd Party data providers,
                                        device usage, demographics etc. Leverage 1st
                                        & 3rd party data
                                    </p>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div className="position-relative h-100">
                                <div className="position-absolute w-100 h-100 rounded wow zoomIn"
                                    data-wow-delay="0.9s">
                                    <Image
                                        src={ads}
                                        alt="Why-choose-us"
                        ...
                        <div className="col-lg-4">
                            <div className="row g-5">
                                <div className="col-12 wow zoomIn" data-wow-delay="0.4s">
                                    ...
                                    <p className="mb-0">
                                        Create dynamic & powerful creatives for your
                                        audiences with “personalized content for
                                        your future prospects” created using YOUR
                                        first party data
                                    </p>
                                </div>
                                <div className="col-12 wow zoomIn" data-wow-delay="0.8s">
                                    <h4 className="text-primary">Partner with relevant websites</h4>
                                    <p className="mb-0">
                                        Understand where your audience resides &
                                        run exclusive campaigns with negotiated
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="container-fluid pb-5 wow fadeInUp text-white targeting-options" data-wow-delay="0.1s">
                <div className="container py-5">
                    ...
                    <div className="row g-4">
                        ...
                        <div className="col-lg-4">
                            ...
                            <p>Target users based on their demographic, interests,and household income.</p>
                        </div>
                        <div className="col-lg-4">
                            <i className="fs-1 bi bi-clock"></i>
                            <h5 className="text-white">TIME</h5>
                            <p>Target specific times of the day based on user behavior. Uncover the most valuable times and optimize. </p>
                        </div>
                        <div className="col-lg-4">
                            <i className="fs-1 bi bi-pc-display-horizontal"></i>
                            <h5 className="text-white">PLATFORM</h5>
                            <p>Target by desktop,tablet, or mobile device.Target mobile campaigns by operating system. </p>
                        </div>
                        <div className="col-lg-4">
                            <i className="fs-1 bi bi-globe"></i>
                            <h5 className="text-white">GEOGRAPHY</h5>
                            <p>Geo target your campaigns by country,city, state or postal code in over 180 countries</p>
                        </div>
                        <div className="col-lg-4">
                            <i className="fs-1 bi bi-menu-button"></i>
                            <h5 className="text-white">CONTEXT</h5>
                            <p>Target any users who are interested in certain page contexts, such as Contact Center.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container py-5">
                    ...
                    <div className="row g-5">
                        <div className="col-lg-3">
                            ...
                            <p>Paying per impression on millions of apps & websites, enables lower costs compared to traditional media buying</p>
                        </div>
                        <div className="col-lg-3">
                            <div
                            ...
                            <p>Create an impact by being available throughout the “buyer journey”</p>
                        </div>
                        <div className="col-lg-3">
                            <div
                                className="bg-primary rounded d-flex align-items-center justify-content-center mb-3"
                        ...
                        <div className="col-lg-3">
                            ...
                            <p>Analyze & Optimize your performance in real time. Get meaningful insights to scale digital efforts</p>
                        </div>
                    </div>
                </div>
            </div>
